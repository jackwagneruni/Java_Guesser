...
public class Guesser {
    ...
    public static void human_guesser (Scanner scanner_variable) {
        ...
        //System.out.println("Correct number is " + correct_number); // debugging purposes, shows correct answer on terminal
        boolean repeat_guessing_loop = true;
        while (repeat_guessing_loop) {
            System.out.println(counter + ") What is your guess?");
            int current_guess = scanner_variable.nextInt();
            //System.out.println("You guessed: " + current_guess);
            
            if (counter >= 7) {
                System.out.println("Your took longer than 7 guesses, if computer mode was used, it would have guessed by now");
